...
#
# 🆕 313 — AND THE THIRD ROUTING, WHICH IS THE ONE NO SESSION HAD DRIVEN. 312's block is
# the first this table has held that sits AFTER a release rather than ON one: its own
# host/addon pair equals 311's, so the pair 311 -> 312 has no cut IN it, and a reader
# that stopped at that question would compare them. `untagged_partition` asks a second
# question — whether a cut stands one step FURTHER back — and 311's pair differs from
# 310's, so 312 lands in `after a cut` and `unshipped_partition` inherits the routing
# through `no_cut`. 🔵 THE REASON IS THE PREMISE, NOT THE ARITHMETIC. `untagged` and
# `unshipped` are counts measured FROM the newest tag, and the tag moved between 310 and
# 311; the block written after that move is the first one whose counts restart, so the
# predecessor it would be compared against is counting from somewhere else. Comparing
# them would be comparing two numbers with different origins, which is exactly the
# excuse `cut` exists to refuse to need.
#
# 🔴 SO BOTH ARMS ARE GREEN ON THIS PAIR AND THAT IS THE CLAIM, NOT A GAP. 313's drive
# perturbs 312's `unshipped 0` DOWNWARD (there is nowhere below zero, so the drive is
# 311's `unshipped 1` held and 312's raised past its own `MOVED +2`) in both directions
# — a fall and an outrun — and expects `UNSHIPPED_POPULATION` to stay silent both times,
# while clause one and clause three still redden on the same block. A bound that goes
...
"""),
    (295, """> ```
> main                 0625249 — the name of a file, and a green answer to a question nobody asked (#371)  MOVED +1
> branch 295           session295-the-name-of-a-file · PR #371
>                      🟢 PUSHED AND MERGED at `a1b38e4`, squashed to `0625249`
> host / addon         1.83.0 / 1.15.0  🟢 UNMOVED — no source touched under addons/
> npm                  🟢 registry 1.83.0 · untagged 11 ·
>                      0 open issues / 0 open PRs
> assetlib             🟢 addon 1.15.0 live
> 🟢 CI GREEN — 26 of 26 required checks at a1b38e4, and the post-merge run at 0625249
> 🟢 `sdk-drift` GREEN at 0625249 — dispatched by this session AFTER the merge, §2.4
> 🔴 registry_lag REFUSES — untagged 11 against a ceiling of 8, crossed at 293, see §3.2
> 🟢 VERIFIED AFTER THE CHANGE   950/950 · contract 32/32 · scope 75 · control 83 · 26 CI jobs
>               · instrument ok across 23 · LATE_LIVE 21/8 · 0 crashes · blast 2992
>               · late not-loaded 0 · late constructed 322/160
>               · py gates 18/6/12 · SIG 260/105
>               · discover 56/15/15/28 · 0 exempt · 0 undeclared
...
>               · wire_diff_key 292 tools / 3852 nodes / 20 keys / 0 problems
>               · wire_invisible 34 cases · lint_ceiling 18 py
>               · taut 4992 · duration 4 sites / 2 lower / 2 guarded
>               · orphan 44/44 · difference_field 28 population / 5 unreachable / 5 declared
>               · mutlock 5 guarded / 23 cases · tree_quiet 13
>               · queue 83/83 claims · handoff 524 claims
>               · landscape 4 channel(s) / 52 analysed / 48 surfaced
>               · capability 43 claimed / 35 unread / 10 uncited
>               · cadence 33 within / 5 past / 14 never analysed
>               · error-code discipline 60 reads / 30 raise sites / 12 host-origin vs 56
...
"""),
    (299, """> ```
> main                 6953740 — session299 the tool that puts you back, and a pin table that can say why (#375)  MOVED +1
> branch 299           session299-the-tool-that-puts-you-back · PR #375
> host / addon         1.84.0 / 1.15.0  🔴 HOST MOVED — the owed MINOR, cut here ·
>                      wire MINOR · toolchain PATCH · addon stamped 1.15.0, no source touched under addons/
> npm                  🟡 registry 1.83.0 · untagged 15 ·
>                      0 open issues / 0 open PRs
> assetlib             🟢 addon 1.15.0 live
> 🟢 CI GREEN — 26 of 26 required checks at the merge, and the post-merge run at 6953740
> 🔴 registry_lag REFUSES — untagged 15 against a ceiling of 8; only the TAG clears it, §3.1
> 🟢 VERIFIED AFTER THE CHANGE   981/981 · contract 32/32 · scope 75 · control 83 · 26 CI jobs
>               · instrument ok across 23 · LATE_LIVE 21/8 · 0 crashes · blast 3022
>               · late not-loaded 0 · late constructed 322/160
>               · py gates 18/6/12 · SIG 260/105
>               · discover 56/15/15/28 · 0 exempt · 0 undeclared
>               · floor_pin 113 · 56 governed · 2206 keys · 99 shortfalls
...
>               · orphan 44/44 · difference_field 28 population / 5 unreachable / 5 declared
>               · mutlock 5 guarded / 23 cases · tree_quiet 13
>               · queue 83/83 claims · handoff 534 claims
>               · landscape 4 channel(s) / 52 analysed / 48 surfaced
>               · capability 43 claimed / 35 unread / 10 uncited
>               · cadence 30 within / 8 past / 14 never analysed
>               · error-code discipline 60 reads / 30 raise sites / 12 host-origin vs 56
...
"""),
    (300, """> ```
> main                 4787bb0 — session300 the reader that went looking for a literal three refactors gone (#376)  MOVED +1
> branch 300           session300-the-reader-that-went-looking-for-a-literal · PR #376
> host / addon         1.84.0 / 1.15.0  🔴 HOST MOVED against the newest BLOCK — see below ·
>                      wire PATCH · toolchain PATCH · addon stamped 1.15.0, no source touched under addons/
> npm                  🟢 registry 1.84.0 · untagged 1 ·
>                      0 open issues / 0 open PRs
> assetlib             🟢 addon 1.15.0 live
> 🟢 CI GREEN — 26 of 26 required checks at the merge, on the THIRD attempt
> 🟢 registry_lag PASSES — first green run since 293; the TAG is what cleared it
> 🟢 VERIFIED AFTER THE CHANGE   981/981 · contract 32/32 · scope 75 · control 83 · 26 CI jobs
>               · instrument ok across 23 · LATE_LIVE 21/8 · 0 crashes · blast 3024
>               · late not-loaded 0 · late constructed 323/160
>               · py gates 18/6/12 · SIG 261/105
>               · discover 56/15/15/28 · 0 exempt · 0 undeclared
>               · floor_pin 113 · 56 governed · 2207 keys · 99 shortfalls
>               · target reasons 113 bound / 0 unreasoned / ceiling 0
>               · unswept 0 · exempt 42 · term 324 file(s) / 21 suffixes
>               · seal 104 · boundary 193 judged / DISCOVER 9-2-0
>               · wire_diff_key 292 tools / 3864 nodes / 20 keys / 0 problems
...
"""),
    (301, """> ```
> main                 83478e3 — session301 the unread half of the version line, put on the board (#378)  MOVED +2
> branch 301           session301-the-blocks-that-were-owed · PR #377 ·
>                      session301-the-unread-half-of-the-version-line · PR #378
> host / addon         1.84.0 / 1.15.0  🟢 UNMOVED — no source touched under addons/
> npm                  🟢 registry 1.84.0 · untagged 3 ·
>                      0 open issues / 0 open PRs
> assetlib             🟢 addon 1.15.0 live
> 🟢 CI GREEN — 26 of 26 required checks at each merge, on the FIRST attempt both times
> 🟢 registry_lag PASSES — second session running
> 🟢 VERIFIED AFTER THE CHANGE   981/981 · contract 32/32 · scope 75 · control 83 · 26 CI jobs
>               · instrument ok across 23 · LATE_LIVE 21/8 · 0 crashes · blast 3033
>               · late not-loaded 0 · late constructed 323/160
>               · py gates 18/6/12 · SIG 261/105
>               · discover 56/15/15/28 · 0 exempt · 0 undeclared
>               · floor_pin 113 · 56 governed · 2207 keys · 99 shortfalls
...
>               · orphan 44/44 · difference_field 28 population / 5 unreachable / 5 declared
>               · mutlock 5 guarded / 23 cases · tree_quiet 13
>               · queue 83/83 claims · handoff 536 claims
>               · landscape 4 channel(s) / 52 analysed / 48 surfaced
>               · capability 43 claimed / 35 unread / 10 uncited
...
"""),
    (302, """> ```
> main                 32f2a7a — session302 the two MOVED aliases, one atom apart (#380)  MOVED +2
> branch 302           session302-the-block-that-was-owed-and-the-armed-gate · PR #379 ·
>                      session302-the-two-moved-aliases-one-atom-apart · PR #380
> host / addon         1.84.0 / 1.15.0  🟢 UNMOVED — no source touched under addons/
> npm                  🟢 registry 1.84.0 · untagged 5 ·
>                      0 open issues / 0 open PRs
> assetlib             🟢 addon 1.15.0 live
> 🟢 CI GREEN — 26 of 26 required checks at each merge, on the FIRST attempt both times
> 🟢 registry_lag PASSES — third session running
> 🟢 VERIFIED AFTER THE CHANGE   981/981 · contract 32/32 · scope 75 · control 83 · 26 CI jobs
>               · instrument ok across 23 · LATE_LIVE 21/8 · 0 crashes · blast 3038
>               · late not-loaded 0 · late constructed 323/160
>               · py gates 18/6/12 · SIG 261/105
>               · discover 56/15/15/28 · 0 exempt · 0 undeclared
>               · floor_pin 113 · 56 governed · 2207 keys · 99 shortfalls
...
>               · orphan 44/44 · difference_field 28 population / 5 unreachable / 5 declared
>               · mutlock 5 guarded / 23 cases · tree_quiet 13
>               · queue 83/83 claims · handoff 537 claims
>               · landscape 4 channel(s) / 52 analysed / 48 surfaced
>               · capability 43 claimed / 35 unread / 10 uncited
>               · cadence 27 within / 11 past / 14 never analysed
>               · error-code discipline 60 reads / 30 raise sites / 12 host-origin vs 56
...
"""),
    (303, """> ```
> main                 0e30e4b — session303 the version line that could only be right, and the sign that lets it be wrong (#382)  MOVED +2
> branch 303           session303-the-block-that-was-owed-and-the-row-below-it · PR #381 ·
>                      session303-the-version-line-that-could-only-be-right · PR #382
> host / addon         1.84.0 / 1.15.0  🟢 UNMOVED — no source touched under addons/
> npm                  🟢 registry 1.84.0 · untagged 7 ·
>                      0 open issues / 0 open PRs
> assetlib             🟢 addon 1.15.0 live
> 🟢 CI GREEN — 26 of 26 required checks at each merge, on the FIRST attempt both times
> 🟢 registry_lag PASSES — fourth session running
> 🟢 VERIFIED AFTER THE CHANGE   981/981 · contract 32/32 · scope 75 · control 83 · 26 CI jobs
>               · instrument ok across 23 · LATE_LIVE 21/8 · 0 crashes · blast 3059
>               · late not-loaded 0 · late constructed 323/160
>               · py gates 18/6/12 · SIG 261/105
>               · discover 56/15/15/28 · 0 exempt · 0 undeclared
>               · floor_pin 113 · 56 governed · 2208 keys · 99 shortfalls
>               · target reasons 113 bound / 0 unreasoned / ceiling 0
>               · unswept 0 · exempt 42 · term 324 file(s) / 21 suffixes
>               · seal 104 · boundary 193 judged / DISCOVER 9-2-0
>               · wire_diff_key 292 tools / 3864 nodes / 20 keys / 0 problems
...
>               · orphan 44/44 · difference_field 28 population / 5 unreachable / 5 declared
>               · mutlock 5 guarded / 23 cases · tree_quiet 13
>               · queue 83/83 claims · handoff 564 claims
>               · landscape 4 channel(s) / 52 analysed / 48 surfaced
>               · capability 43 claimed / 35 unread / 10 uncited
>               · cadence 27 within / 11 past / 14 never analysed
>               · error-code discipline 60 reads / 30 raise sites / 12 host-origin vs 56
...
"""),
    (304, """> ```
> main                 e033e64 — session304 the ritual nobody could reach, and the argument that said nobody could (#384)  MOVED +2
> branch 304           session304-the-block-that-was-owed-and-the-head · PR #383 ·
>                      session304-the-ritual-nobody-could-reach · PR #384
> host / addon         1.84.0 / 1.15.0  🟢 UNMOVED — no source touched under addons/
> npm                  🔴 registry 1.84.0 · untagged 9 ·
>                      0 open issues / 0 open PRs
> assetlib             🟢 addon 1.15.0 live
> 🟢 CI GREEN — 26 of 26 required checks at each merge
> 🔴 registry_lag REFUSES — untagged 9 against a ceiling of 8, the first refusal in five
>    sessions, and the remedy is a TAG rather than a bigger ceiling
> 🟢 VERIFIED AFTER THE CHANGE   981/981 · contract 32/32 · scope 75 · control 83 · 26 CI jobs
>               · instrument ok across 23 · LATE_LIVE 21/8 · 0 crashes · blast 3098
...
>               · orphan 44/44 · difference_field 28 population / 5 unreachable / 5 declared
>               · mutlock 5 guarded / 23 cases · tree_quiet 13
>               · queue 83/83 claims · handoff 565 claims
>               · landscape 4 channel(s) / 52 analysed / 48 surfaced
>               · capability 43 claimed / 35 unread / 10 uncited
>               · cadence 27 within / 11 past / 14 never analysed
>               · error-code discipline 60 reads / 30 raise sites / 12 host-origin vs 56
...
"""),
    (306, """> ```
> main                 4fdb844 — session306 the sign that was never a claim, the absence with no shape, and the roster nobody read (#388)  MOVED +2
> branch 306           session306-the-block-that-moved-and-the-roster-nobody-read · PR #387 ·
>                      session306-the-sign-that-was-never-a-claim · PR #388
> host / addon         1.84.1 / 1.15.0  🟢 UNMOVED — no source touched under host/src or addons/
> npm                  🟢 registry 1.84.1 · untagged 2 ·
>                      0 open issues / 0 open PRs
> assetlib             🟢 addon 1.15.0 live
> 🟢 CI GREEN — 26 of 26 required checks at each merge, and the post-merge run at 4fdb844
> 🟢 registry_lag PASSES — untagged 2, distance 0, both bounds green
> 🟢 VERIFIED AFTER THE CHANGE   981/981 · contract 32/32 · scope 75 · control 83 · 26 CI jobs
>               · instrument ok across 23 · LATE_LIVE 21/8 · 0 crashes · blast 3126
>               · late not-loaded 0 · late constructed 330/160
>               · py gates 18/6/12 · SIG 269/105
>               · discover 56/15/15/28 · 0 exempt · 0 undeclared
>               · floor_pin 113 · 56 governed · 2236 keys · 99 shortfalls
>               · target reasons 113 bound / 0 unreasoned / ceiling 0
>               · unswept 0 · exempt 42 · term 324 file(s) / 21 suffixes
>               · seal 104 · boundary 193 judged / DISCOVER 9-2-0
>               · wire_diff_key 292 tools / 3864 nodes / 20 keys / 0 problems
...
>               · orphan 44/44 · difference_field 28 population / 5 unreachable / 5 declared
>               · mutlock 5 guarded / 23 cases · tree_quiet 13
>               · queue 83/83 claims · handoff 580 claims
...
"""),
    (307, """> ```
> main                 2370015 — session307 the readers that asked the text a question about the code (#390)  MOVED +2
> branch 307           session307-the-block-and-the-field-nobody-reads · PR #389 ·
>                      session307-the-readers-that-asked-the-text · PR #390
> host / addon         1.84.1 / 1.15.0  🟢 UNMOVED — no source touched under host/src or addons/
> npm                  🟢 registry 1.84.1 · untagged 4 ·
>                      0 open issues / 0 open PRs
> assetlib             🟢 addon 1.15.0 live
> 🟢 CI GREEN — 26 of 26 required checks at each merge, and the post-merge run at 2370015
> 🟢 registry_lag PASSES — untagged 4, distance 0, both bounds green
> 🟢 VERIFIED AFTER THE CHANGE   981/981 · contract 32/32 · scope 75 · control 83 · 26 CI jobs
>               · instrument ok across 23 · LATE_LIVE 21/8 · 0 crashes · blast 3154
>               · late not-loaded 0 · late constructed 334/160
>               · py gates 18/6/12 · SIG 273/105
>               · discover 56/15/15/28 · 0 exempt · 0 undeclared
>               · floor_pin 113 · 56 governed · 2240 keys · 100 shortfalls
>               · target reasons 113 bound / 0 unreasoned / ceiling 0
>               · unswept 0 · exempt 42 · term 324 file(s) / 21 suffixes
>               · seal 104 · boundary 193 judged / DISCOVER 9-2-0
>               · wire_diff_key 292 tools / 3864 nodes / 20 keys / 0 problems
>               · wire_invisible 34 cases · lint_ceiling 18 py
>               · taut 5062 · duration 4 sites / 2 lower / 2 guarded
>               · orphan 26/44 · difference_field 28 population / 5 unreachable / 5 declared
>               · mutlock 5 guarded / 23 cases · tree_quiet 13
>               · queue 83/83 claims · handoff 587 claims
>               · landscape 4 channel(s) / 52 analysed / 49 surfaced
>               · capability 43 claimed / 35 unread / 10 uncited
>               · cadence 27 within / 11 past / 14 never analysed
>               · error-code discipline 60 reads / 30 raise sites / 12 host-origin vs 56
...
"""),
    (308, """> ```
> main                 37160e9 — session308 the error message that read as a command (#394)  MOVED +4
> branch 308           session308-the-block-and-the-fourth-field · PR #391 ·
>                      session308-the-ceiling-the-alarm-and-the-fourth-field · PR #392 ·
>                      session308-the-row-that-was-prose-for-ten-sessions · PR #393 ·
>                      session308-the-message-that-read-as-a-command · PR #394
> host / addon         1.84.1 / 1.15.0  🟢 UNMOVED — no source touched under host/src or addons/
> npm                  🟢 registry 1.84.1 · untagged 8 ·
>                      0 open issues / 0 open PRs
> assetlib             🟢 addon 1.15.0 live
> 🟢 CI GREEN — 26 of 26 required checks at each merge, and the post-merge run at 37160e9
> 🔴 registry_lag PASSES AT ITS EDGE — untagged 8 against a ceiling of 8, distance 0
> 🟢 VERIFIED AFTER THE CHANGE   981/981 · contract 32/32 · scope 75 · control 83 · 26 CI jobs
>               · instrument ok across 23 · LATE_LIVE 21/8 · 0 crashes · blast 3175
>               · late not-loaded 0 · late constructed 338/160
>               · py gates 18/6/12 · SIG 277/105
>               · discover 56/15/15/28 · 0 exempt · 0 undeclared
>               · floor_pin 113 · 56 governed · 2263 keys · 100 shortfalls
>               · target reasons 113 bound / 0 unreasoned / ceiling 0
>               · unswept 0 · exempt 42 · term 324 file(s) / 21 suffixes
>               · seal 104 · boundary 193 judged / DISCOVER 9-2-0
>               · wire_diff_key 292 tools / 3864 nodes / 20 keys / 0 problems
...
"""),
    (312, """> ```
> main                 e9d4587 — session312 the ceiling follows the surface down, and the reason sentence that had gone false (#405)  MOVED +2
> branch 312           session312-the-block-that-cut-a-release · PR #404 ·
>                      session312-the-ceiling-follows-the-surface-down · PR #405
> host / addon         1.85.0 / 1.16.0  🟢 UNMOVED — no source touched under host/src or addons/
> npm                  🟢 registry 1.85.0 · untagged 2 · unshipped 0 ·
>                      0 open issues / 0 open PRs
> assetlib             🟢 addon 1.16.0 live
> 🟢 CI GREEN — 26 of 26 required checks at each merge, and the post-merge run at e9d4587
> 🟢 registry_lag PASSES ON THE NUMBER THAT MATTERS — unshipped 0 against a ceiling of 6
> 🟢 VERIFIED AFTER THE CHANGE   981/981 · contract 32/32 · scope 75 · control 83 · 26 CI jobs
>               · instrument ok across 23 · LATE_LIVE 21/8 · 0 crashes · blast 3232
>               · late not-loaded 0 · late constructed 342/160
>               · py gates 18/6/12 · SIG 281/105
>               · discover 56/15/15/28 · 0 exempt · 0 undeclared
>               · floor_pin 113 · 56 governed · 2268 keys · 100 shortfalls
...
>               · orphan 26/26 · difference_field 28 population / 5 unreachable / 5 declared
>               · mutlock 5 guarded / 23 cases · tree_quiet 13
>               · queue 83/83 claims · handoff 612 claims
>               · landscape 4 channel(s) / 52 analysed / 49 surfaced
>               · capability 43 claimed / 35 unread / 10 uncited
>               · cadence 27 within / 11 past / 14 never analysed
>               · error-code discipline 60 reads / 30 raise sites / 12 host-origin vs 57
...
"""),
    (316, """> ```
> main                 4c46c76 — session316 the owed block, and the exemption that expired on the run that registered it (#416)  MOVED +1
> branch 316           session316-the-owed-block-and-the-head · PR #416
> host / addon         1.85.1 / 1.16.0  🟢 UNMOVED — no source touched under host/src or addons/
> npm                  🟢 registry 1.85.1 · untagged 5 · unshipped 0 ·
>                      0 open issues / 1 open PRs
> assetlib             🟢 addon 1.16.0 live
> 🟢 CI GREEN — 26 of 26 required checks at the merge, post-merge run at 4c46c76
> 🟢 registry_lag PASSES ON THE NUMBER THAT MATTERS — unshipped 0 against a ceiling of 6
> 🟢 VERIFIED AFTER THE CHANGE   988/988 · contract 32/32 · scope 75 · control 83 · 26 CI jobs
>               · instrument ok across 24 · LATE_LIVE 22/8 · 0 crashes · blast 3387
>               · late not-loaded 0 · late constructed 359/160
>               · py gates 18/6/12 · SIG 296/105
>               · discover 58/16/16/30 · 0 exempt · 0 undeclared
...
>               · orphan 27/27 · difference_field 28 population / 5 unreachable / 5 declared
>               · mutlock 5 guarded / 23 cases · tree_quiet 13
>               · queue 84/84 claims · handoff 644 claims
>               · landscape 4 channel(s) / 55 analysed / 45 surfaced
>               · capability 55 claimed / 35 unread / 10 uncited
>               · cadence 27 within / 14 past / 14 never analysed
>               · identity 69 of 100 / 1 renamed / 0 collisions
>               · error-code discipline 60 reads / 30 raise sites / 12 host-origin vs 57
>                 addon / 0 problems
> ```
"""),
    (317, """> ```
> main                 33c3262 — session317c the block a close note does not carry, and the queue that could not say so (#418)  MOVED +2
> branch 317           session317-the-decline-nothing-had-ever-taken · PR #417 ·
>                      session317c-the-block-a-close-note-does-not-carry · PR #418
> host / addon         1.85.1 / 1.16.0  🟢 UNMOVED — no source touched under host/src or addons/
> npm                  🟢 registry 1.85.1 · untagged 7 · unshipped 0 ·
>                      0 open issues / 0 open PRs
> assetlib             🟢 addon 1.16.0 live
> 🟢 CI GREEN — 26 of 26 required checks at each of the two merges, post-merge run at 33c3262
> 🟢 registry_lag PASSES ON THE NUMBER THAT MATTERS — unshipped 0 against a ceiling of 6
> 🟢 VERIFIED AFTER THE CHANGE   1005/1005 · contract 32/32 · scope 75 · control 83 · 26 CI jobs
>               · instrument ok across 24 · LATE_LIVE 22/8 · 0 crashes · blast 3392
>               · late not-loaded 0 · late constructed 359/160
>               · py gates 18/6/12 · SIG 296/105
>               · discover 58/16/16/30 · 0 exempt · 0 undeclared
>               · floor_pin 116 · 56 governed · 2390 keys · 100 shortfalls
...
>               · wire_diff_key 292 tools / 3864 nodes / 20 keys / 0 problems
>               · wire_invisible 34 cases · lint_ceiling 18 py
>               · taut 5155 · duration 4 sites / 2 lower / 2 guarded
>               · orphan 27/27 · difference_field 28 population / 5 unreachable / 5 declared
>               · mutlock 5 guarded / 23 cases · tree_quiet 13
>               · queue 84/84 claims · handoff 645 claims
>               · landscape 4 channel(s) / 55 analysed / 45 surfaced
>               · capability 55 claimed / 35 unread / 10 uncited
>               · cadence 27 within / 14 past / 14 never analysed
>               · identity 69 of 100 / 1 renamed / 0 collisions
...
"""),
    (318, """> ```
> main                 046b0a2 — session318 the holder the refusal was forbidden to name, and the command it handed a person to run (#419)  MOVED +1
> branch 318           session318-who-holds-the-port · PR #419
> host / addon         1.85.1 / 1.16.0  🟢 UNMOVED — no cut; host/src changed and ships at the next publish (BP-0013)
> npm                  🟢 registry 1.85.1 · untagged 8 · unshipped 1 ·
>                      0 open issues / 0 open PRs
> assetlib             🟢 addon 1.16.0 live
> 🟢 CI GREEN — 26 of 26 required checks at the merge, post-merge run at 046b0a2
> 🟢 registry_lag PASSES ON THE NUMBER THAT MATTERS — unshipped 1 against a ceiling of 6
> 🟢 VERIFIED AFTER THE CHANGE   1018/1018 · contract 32/32 · scope 75 · control 83 · 26 CI jobs
>               · instrument ok across 24 · LATE_LIVE 22/8 · 0 crashes · blast 3397
>               · late not-loaded 0 · late constructed 359/160
>               · py gates 18/6/12 · SIG 296/105
>               · discover 58/16/16/30 · 0 exempt · 0 undeclared
>               · floor_pin 116 · 56 governed · 2390 keys · 100 shortfalls
...
>               · orphan 27/27 · difference_field 28 population / 5 unreachable / 5 declared
>               · mutlock 5 guarded / 23 cases · tree_quiet 13
>               · queue 84/84 claims · handoff 646 claims
>               · landscape 4 channel(s) / 55 analysed / 45 surfaced
>               · capability 55 claimed / 35 unread / 10 uncited
>               · cadence 21 within / 20 past / 14 never analysed
>               · identity 69 of 100 / 1 renamed / 0 collisions
...
"""),
    (319, """> ```
> main                 baa9929 — session319b the block a release cut did not carry, and the head that could not move without it (#421)  MOVED +2
> branch 319           session319-release-1.86.0 · PR #420 ·
>                      session319b-the-block-a-release-cut-did-not-carry · PR #421
> host / addon         1.86.0 / 1.16.0  🔴 HOST MOVED — the 1.86.0 cut; addons/ untouched
> npm                  🟢 registry 1.85.1 · untagged 10 · unshipped 2 ·
>                      0 open issues / 0 open PRs
> assetlib             🟢 addon 1.16.0 live
> release              🔴 1.85.1 -> 1.86.0 MINOR · wire MINOR · toolchain PATCH —
>                      cut and merged, NOT tagged and NOT published
> 🟢 CI GREEN — 26 of 26 required checks at each of the two merges, post-merge run at baa9929
> 🟢 registry_lag PASSES ON THE NUMBER THAT MATTERS — unshipped 2 against a ceiling of 6
> 🟢 VERIFIED AFTER THE CHANGE   1018/1018 · contract 32/32 · scope 75 · control 83 · 26 CI jobs
>               · instrument ok across 24 · LATE_LIVE 22/8 · 0 crashes · blast 3403
>               · late not-loaded 0 · late constructed 359/160
>               · py gates 18/6/12 · SIG 296/105
>               · discover 58/16/16/30 · 0 exempt · 0 undeclared
>               · floor_pin 116 · 56 governed · 2390 keys · 100 shortfalls
...
>               · orphan 27/27 · difference_field 28 population / 5 unreachable / 5 declared
>               · mutlock 5 guarded / 23 cases · tree_quiet 13
>               · queue 84/84 claims · handoff 647 claims
>               · landscape 4 channel(s) / 55 analysed / 45 surfaced
>               · capability 55 claimed / 35 unread / 10 uncited
>               · cadence 21 within / 20 past / 14 never analysed
>               · identity 69 of 100 / 1 renamed / 0 collisions
