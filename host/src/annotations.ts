...
const READ_ONLY: readonly string[] = [
  ...
  "godot_output", "godot_version", "inputmap_list", "node_find", "node_get_children", "node_get_path",
...
const IDEMPOTENT: readonly string[] = [
  ...
  "mesh_set_surface_material", "mp_scaffold_lobby", "mp_set_authority", "mp_setup_enet_peer",
...
export const ALL_ANNOTATED: readonly string[] = [
  ...
  "leaderboard_scaffold", "light_create", "mesh_set_surface_material", "meshinstance_create", "mp_add_spawner",
